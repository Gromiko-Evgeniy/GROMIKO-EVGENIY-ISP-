...
namespace Lab3_ISP
{
    abstract class Car : Vehicle
    {
        ...
        public Car(string _fyelType, float _fyelQuantity, float _fyelConsumption, float _fuelTankVolume, float _maxSpeed, float _accelerationTimeToMaxSpeed)
        ...
        public void ChangeMotor(string newFyelType, float newFyelConsumption, float newMaxSpeed, float newAccelerationTimeToMaxSpeed)
        {
            ...
            MotorAge motorAge = MotorAge.newMotor;
        }
